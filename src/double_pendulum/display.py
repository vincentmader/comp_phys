...
def main(
    ...
    while True:
        ...
        if christmas_mode and frame_num == 375:  # <3
        ...
        tail_length = TAIL_LENGTH if not christmas_mode else 150
        fading_tails = False if christmas_mode else True
        draw_tail(
        ...
        if not christmas_mode and not screenshot_mode:
